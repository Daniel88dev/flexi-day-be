...
export const presentSession = (session: AttendanceSessionView) => ({
  ...
  enteredByUserId: session.enteredByUserId,
  changedAfterDay: session.changedAfterDay,
...
export const presentAttendanceState = (state: AttendanceStateType) => ({
  ...
  administersOwnAttendance: state.administersOwnAttendance,
...
export const presentAttendanceMonth = (month: AttendanceMonthType) => ({
  ...
  days: month.days.map((day) => ({
    ...
    entered: day.entered,
    changedAfterDay: day.changedAfterDay,
    flagged: day.flagged,
